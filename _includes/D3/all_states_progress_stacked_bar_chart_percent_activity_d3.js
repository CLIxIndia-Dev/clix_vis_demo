...
d3.csv("{{site.github.url}}/data/all_states_percent_activity_viz_top50.csv", function(error, data) {
...
svg.append("text")
  ...
  svg.append('text')
      ...
      .attr("y",   50)
      .style("text-anchor", "middle")
      .text("Average Percentage of Activities Visited in a Module (Jul, 2018 - Dec, 2018)")
