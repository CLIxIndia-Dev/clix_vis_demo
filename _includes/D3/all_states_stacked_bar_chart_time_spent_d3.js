...
d3.csv("{{site.github.url}}/data/all_states_time_spent_viz_top50.csv", function(error, data) {
  ...
  svg.append("text")
      ...
      .text("*In minutes and averaged across days; All users - logged-in, buddy users and anonymous users are included");
