...
d3.csv("{{site.github.url}}/data/all_states_total_students_viz_top50.csv", function(error, data) {
...
svg.append("text")
  ...
  svg.append('text')
      ...
      .attr("y",   50)
      .style("text-anchor", "middle")
      .text("Total Number of Students* Engaged with Tool (Jul, 2018 - Jan, 2019)")
  ...
  svg.append('text')
      ...
      .attr("y",   80)
      .style("text-anchor", "middle")
      .text("(for top 50 schools across all states)")
      .style("font-size", "18px")
      .style("fill", 'darkblue')
