$( document ).ready(function() {
    render_chart(json_data = "{{site.github.url}}/data/all_states_module_days_monthly.json");
 });
...
svg.append("text")
        ...
        .attr("dx", ".71em")
        .attr("dy", "-.71em")
        .text("*By all students logged-in and buddy users");
    ...
    d3.selectAll(".m")
				.on("click", function() {
					...
					if(date == "Chhattisgarh"){
						str = "{{site.github.url}}/data/ct_module_days_monthly.json";
					}else if(date == "Rajasthan"){
						str = "{{site.github.url}}/data/rj_module_days_monthly.json";
					}else if(date == "Mizoram"){
						str = "{{site.github.url}}/data/mz_module_days_monthly.json";
					}else if(date == "Telangana"){
						str = "{{site.github.url}}/data/tg_module_days_monthly.json";
					}else{
					//All states top 50 schools
						str = "{{site.github.url}}/data/all_states_module_days_monthly.json";
					}
...
//		.remove();
	...
	//      .remove();
      ...
      svg.append("text")
        ...
        .attr("dx", ".71em")
        .attr("dy", "-.71em")
        .text("*By all students both logged-in and buddy users");
