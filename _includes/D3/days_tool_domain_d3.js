$( document ).ready(function() {
    render_chart(json_data = "{{site.github.url}}/data/all_states_tool_days_monthly.json");
 });
    ...
    d3.selectAll(".m")
				.on("click", function() {
					...
					if(date == "Chhattisgarh"){
						str = "{{site.github.url}}/data/ct_tool_days_monthly.json";
					}else if(date == "Rajasthan"){
						str = "{{site.github.url}}/data/rj_tool_days_monthly.json";
					}else if(date == "Mizoram"){
						str = "{{site.github.url}}/data/mz_tool_days_monthly.json";
					}else if(date == "Telangana"){
						str = "{{site.github.url}}/data/tg_tool_days_monthly.json";
					}else{
					//All states top 50 schools
						str = "{{site.github.url}}/data/all_states_tool_days_monthly.json";
					}
