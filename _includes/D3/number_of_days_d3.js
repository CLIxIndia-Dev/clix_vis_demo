...
d3.csv("/data/all_states_num_days_viz_top50.csv", function(error, dataset) {
...
d3.selectAll(".m")
    .on("click", function() {
	    var statelevel = this.getAttribute("value");
	    var str;
	    if(statelevel == "all_states"){ 
		   str = "/data/all_states_num_days_viz_top50.csv";
		 }else if(statelevel == "chhattisgarh"){
		   str = "/data/ct_num_users_viz_top50.csv";
		 }else if(statelevel == "rajasthan"){
		   str = "/data/rj_num_users_viz_top50.csv";
		 }else if(statelevel == "mizoram"){
		   str = "/data/mz_num_users_viz_top50.csv";
		 }else if(statelevel == "telangana"){
		   str = "/data/tg_num_users_viz_top50.csv";
		}
...
d3.csv(str, function(error, dataset) {
  if (error) throw error;
  data = dataset;
