$( document ).ready(function() {
    render_chart(json_data = "{{site.github.url}}/data/all_states_module_percn_activ_monthly.json");
 });
...
function render_chart(json_data){
    ...
    var rect = layer.selectAll("rect")
        ...
        .attr("dx", ".71em")
        .attr("dy", "-.71em")
        .text("Number of Students Visiting atleast 50% of Module Activities (Month wise)");
...
svg.append("text")
        ...
        .attr("dx", ".71em")
        .attr("dy", "-.71em")
        .text("*All students logged-in and buddy users are considered");
    ...
    d3.selectAll(".m")
				.on("click", function() {
					...
					if(date == "Chhattisgarh"){
						str = "{{site.github.url}}/data/ct_module_percn_activ_monthly.json";
					}else if(date == "Rajasthan"){
						str = "{{site.github.url}}/data/rj_module_percn_activ_monthly.json";
					}else if(date == "Mizoram"){
						str = "{{site.github.url}}/data/mz_module_percn_activ_monthly.json";
					}else if(date == "Telangana"){
						str = "{{site.github.url}}/data/tg_module_percn_activ_monthly.json";
					}else{
					//All states top 50 schools
						str = "{{site.github.url}}data/all_states_module_percn_activ_monthly.json";
					}
...
//		.remove();
	...
	//      .remove();
      ...
      svg.append("text")
        ...
        .attr("dx", ".71em")
        .attr("dy", "-.71em")
        .text("*All students both logged-in and buddy users are considered");
