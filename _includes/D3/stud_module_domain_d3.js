$( document ).ready(function() {
    render_chart(json_data = "{{site.github.url}}/data/all_states_module_stud_monthly.json");
 });
...
function render_chart(json_data){
    ...
    var rect = layer.selectAll("rect")
        ...
        .attr("dx", ".71em")
        .attr("dy", "-.71em")
        .text("Number of Students* Used Modules Section of Platform (Month wise)");
...
svg.append("text")
        ...
        .attr("dx", ".71em")
        .attr("dy", "-.71em")
        .text("*All users both logged-in and buddy-users are considered");
    ...
    d3.selectAll(".m")
				.on("click", function() {
					...
					if(date == "Chhattisgarh"){
						str = "{{site.github.url}}/data/ct_module_stud_monthly.json";
					}else if(date == "Rajasthan"){
						str = "{{site.github.url}}/data/rj_module_stud_monthly.json";
					}else if(date == "Mizoram"){
						str = "{{site.github.url}}/data/mz_module_stud_monthly.json";
					}else if(date == "Telangana"){
						str = "{{site.github.url}}/data/tg_module_stud_monthly.json";
					}else{
					//All states top 50 schools
						str = "{{site.github.url}}/data/all_states_module_stud_monthly.json";
					}
...
//		.remove();
	...
	//      .remove();
        ...
        .attr("dx", ".71em")
        .attr("dy", "-.71em")
        .text("Number of Students* Used Modules Section of Platform (Monthwise)");
      ...
      svg.append("text")
        ...
        .attr("dx", ".71em")
        .attr("dy", "-.71em")
        .text("*Both logged-in and buddy-users are considered");
