...
$(document).ready(function() {
    render_chart(csv_data = "{{site.github.url}}/data/all_states_lab_func.csv");
 });
...
var color = d3.scale.ordinal()
    .range(["#FF4500", "#00008B","#BA55D3", "#00BFFF", "#4B0082"])
...
svg.append("text")
  ...
  svg.append('text')
      ...
      .attr("y",   50)
      .style("text-anchor", "middle")
      .text("Lab Functionality across All States (Jul, 2018 - Mar, 2019)")
...
d3.selectAll(".m")
				.on("click", function() {
					...
					if(date == "Chhattisgarh"){
						csv_data = "{{site.github.url}}/data/ct_lab_func.csv";
						var state_code = 'Chhattisgarh'
					}else if(date == "Rajasthan"){
						csv_data = "{{site.github.url}}/data/rj_lab_func.csv";
						var state_code = 'Rajasthan'
					}else if(date == "Mizoram"){
						csv_data = "{{site.github.url}}/data/mz_lab_func.csv";
						var state_code = 'Mizoram'
					}else if(date == "Telangana"){
						csv_data = "{{site.github.url}}/data/tg_lab_func.csv";
						var state_code = 'Telangana'
					}else{
					//All states top 50 schools
						csv_data = "{{site.github.url}}/data/all_states_lab_func.csv";
