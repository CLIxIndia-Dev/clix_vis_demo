...
$(document).ready(function() {
    render_chart(csv_data = "{{site.github.url}}/data/all_states_toolwise_days.csv");
 });
...
d3.selectAll(".m")
				.on("click", function() {
					...
					if(date == "Chhattisgarh"){
						csv_data = "{{site.github.url}}/data/ct_toolwise_days.csv";
						var state_code = 'Chhattisgarh'
					}else if(date == "Rajasthan"){
						csv_data = "{{site.github.url}}/data/rj_toolwise_days.csv";
						var state_code = 'Rajasthan'
					}else if(date == "Mizoram"){
						csv_data = "{{site.github.url}}/data/mz_toolwise_days.csv";
						var state_code = 'Mizoram'
					}else if(date == "Telangana"){
						csv_data = "{{site.github.url}}/data/tg_toolwise_days.csv";
						var state_code = 'Telangana'
					}else{
					//All states top 50 schools
						csv_data = "{{site.github.url}}/data/all_states_toolwise_days.csv";
