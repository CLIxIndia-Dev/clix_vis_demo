...
$(document).ready(function() {
    render_chart(csv_data = "{{site.github.url}}/data/vis_data/all_states_all_months_toolwise_stud.csv");
 });
...
//      .text("*Only logged-in and buddy users are included, anonymous users are not included");
  ...
  svg.append('text')
      ...
      .attr("y",   50)
      .style("text-anchor", "middle")
      .text("Number of Students Engaged with Different Tools")
...
d3.selectAll(".m")
				.on("click", function() {
					...
					if(date == "Chhattisgarh"){
						csv_data = "{{site.github.url}}/data/vis_data/ct_all_months_toolwise_stud.csv";
						var state_code = 'Chhattisgarh'
					}else if(date == "Rajasthan"){
						csv_data = "{{site.github.url}}/data/vis_data/rj_all_months_toolwise_stud.csv";
						var state_code = 'Rajasthan'
					}else if(date == "Mizoram"){
						csv_data = "{{site.github.url}}/data/vis_data/mz_all_months_toolwise_stud.csv";
						var state_code = 'Mizoram'
					}else if(date == "Telangana"){
						csv_data = "{{site.github.url}}/data/vis_data/tg_all_months_toolwise_stud.csv";
						var state_code = 'Telangana'
					}else{
					//All states top 50 schools
						csv_data = "{{site.github.url}}/data/vis_data/all_states_all_months_toolwise_stud.csv";
