...
$(document).ready(function() {
    render_chart(csv_data = "{{site.github.url}}/data/all_states_num_users_viz_top50.csv");
 });
...
//      .text("*Only logged-in and buddy users are included, anonymous users are not included");
  ...
  svg.append('text')
      ...
      .attr("y",   50)
      .style("text-anchor", "middle")
      .text("Number of Students Engaged with Different Tools per Day (Jul, 2018 - Mar, 2019)")
...
d3.selectAll(".m")
				.on("click", function() {
					...
					if(date == "Chhattisgarh"){
						csv_data = "{{site.github.url}}/data/ct_num_users_viz_top50.csv";
						var state_code = 'Chhattisgarh'
					}else if(date == "Rajasthan"){
						csv_data = "{{site.github.url}}/data/rj_num_users_viz_top50.csv";
						var state_code = 'Rajasthan'
					}else if(date == "Mizoram"){
						csv_data = "{{site.github.url}}/data/mz_num_users_viz_top50.csv";
						var state_code = 'Mizoram'
					}else if(date == "Telangana"){
						csv_data = "{{site.github.url}}/data/tg_num_users_viz_top50.csv";
						var state_code = 'Telangana'
					}else{
					//All states top 50 schools
						csv_data = "{{site.github.url}}/data/all_states_num_users_viz_top50.csv";
...
//      .text("*Only logged-in and buddy users are included, anonymous users are not included");
  ...
  svg.append('text')
     ...
     .attr("y",   50)
      .style("text-anchor", "middle")
      .text("Number of Students Engaged with Different Tools per Day(July, 2018 - Mar, 2019)")
      .style("font-size", "18px")
      .style("fill", 'black')
